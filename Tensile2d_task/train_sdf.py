...
from utils.dataset import Tensil_2D_SDF, subsample_dataset
...
def main(cfg: DictConfig) -> None:
    ...
    train_ds = Tensil_2D_SDF(train_raw, is_train=True)
    test_ds  = Tensil_2D_SDF(test_raw, is_train=False, coef_norm=train_ds.coef_norm)
